package vulan.com.trackingstore.service;
...
public class LocationUpdatesService extends Service implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final String PACKAGE_NAME =
            "com.ominext.shoppush.manager.service.locationupdatesforegroundservice";
...
//                .addAction(R.mipmap.ic_launcher_round, getString(R.string.remove_location_updates),
...
//    }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (serviceIsRunningInForeground(this)) {
            Log.e("LocationUpdateService", "service running in foreground");
        }
    }
